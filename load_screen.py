...
class BoothUI(tk.Tk):
    def __init__(self):
        ...
        try:
            ...
            print(f"[customize button] could not wire GPIO 6: {_cb_err}")
    ...
    def _render_feed(self, pil_img):
        ...
        if self._countdown_value is not None:
            ...
            c.create_text(cx, cy, text=str(self._countdown_value),
